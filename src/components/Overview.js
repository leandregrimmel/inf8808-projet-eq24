...
const Overview = () => {
  ...
  // Fonction d'affichage des grands nombres
  ...
  return (
    <div className="p-6">
      ...
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Spotify Top Streamed Songs 2024</h1>
        <p className="text-lg text-muted-foreground">
          ...
          chansons évolue après leur sortie. Nous nous intéressons particulièrement
          aux impacts des réseaux sociaux, à l'évolution des tendances
          temporelles et aux interactions multi-plateformes.
        </p>
      </header>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Méthodologie & Visualisations</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc ml-6">
          <li>
            ...
            de l'âge des chansons. Un graphique des tendances saisonnières permet
            de repérer des cycles récurrents.
          </li>
          <li>
            <strong>Multi-plateformes :</strong> Une matrice de corrélation
            interactive et un sunburst chart détaillent les relations entre
            les indicateurs (Spotify, YouTube, TikTok, Shazam…) et la répartition
            de la consommation par artiste.
          </li>
          <li>
            <strong>Contenu Explicite :</strong> Un box plot compare la distribution
            des streams entre pistes explicites et non-explicites, et permet
            d'identifier des variations significatives.
          </li>
          <li>
            <strong>Diffusion & Rayonnement :</strong> Des scatter plots comparent
            la portée des playlists et le nombre de diffusions radio aux mesures
            de popularité en ligne.
          </li>
          <li>
            <strong>Engagement des Utilisateurs :</strong> Des analyses du ratio
            vues/likes et l'impact des posts sur TikTok ainsi que l'engagement sur
            Shazam révèlent comment les interactions influencent la popularité.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          La barre latérale vous permet de naviguer facilement entre les différentes
          sections de l'application. Sélectionnez l'onglet désiré pour explorer les
          visualisations détaillées qui répondent chacune à une partie spécifique de
          notre analyse.
        </p>
      </section>
    </div>
